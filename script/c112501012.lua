...
function cm.thfilter(c)
	return not c:IsCode(m) and c:IsSetCard(0xe7b) and c:IsAbleToHand()
end
...
function cm.spfilter(c,e,tp)
	return c:IsSetCard(0xe7b) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
