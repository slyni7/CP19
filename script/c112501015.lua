--무한번영(논세이브 하드코어 모드) /0x0/ P.S.(패러다임 시프트)
local m=112501015
local cm=_G["c"..m]
...
function cm.drfilter(c,e)
	return c:IsSetCard(0xe7b) and c:IsAbleToDeck() and c:IsCanBeEffectTarget(e)
end
...
function cm.handcon(e)
	return Duel.IsExistingMatchingCard(cm.filter,e:GetHandlerPlayer(),LOCATION_REMOVED,0,1,nil)
end
