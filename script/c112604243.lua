...
function s.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil) end
...
function s.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.GetControl(tc,tp) then
		Duel.BreakEffect()
		Duel.Recover(tp,333,REASON_EFFECT)
	end
	local e1=Effect.CreateEffect(c)
