...
function cm.tfil4(c,lv)
	return c:IsFaceup() and lv>0 and c:IsLevel(lv)
end
function cm.tar4(e,c)
	local tp=c:GetControler()
	return (c:IsType(TYPE_EFFECT) or c:GetOriginalType()&TYPE_EFFECT==TYPE_EFFECT)
		and (c:IsType(TYPE_XYZ) or Duel.IEMCard(cm.tfil4,tp,"M",0,1,c,c:GetLevel()))
		and not c:IsSetCard("½ºÅ¾ À¯Â¡")
end