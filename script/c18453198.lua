...
function cm.tar1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SOI(0,CATEGORY_RECOVER,nil,0,tp,200)
end
function cm.ofil1(c)
	return c:IsSetCard(0x2e6) and c:IsType(TYPE_MONSTER) and c:GetLevel()%2==0 and c:IsAbleToHand()
end
...
function cm.tfil2(c)
	return c:IsSetCard(0x12e6) and c:GetType()&TYPE_TRAP+TYPE_CONTINUOUS==TYPE_TRAP+TYPE_CONTINUOUS and c:IsAbleToHand()
end
