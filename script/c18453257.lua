...
function cm.initial_effect(c)
	aux.AddEquationProcedure(c,nil,2,2,0)
...
function cm.con1(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsSummonType(SUMMON_TYPE_EQUATION) then
		e:SetLabel(1)
	else
		e:SetLabel(2)
	end
...
function cm.tfil1(c,label)
	return c:IsAbleToHand() and
		((c:IsSetCard(0x2eb) and c:IsCustomType(CUSTOMTYPE_EQUATION) and not c:IsCode(m) and label==1)
