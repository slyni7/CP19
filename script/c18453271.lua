...
function cm.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddBeyondProcedure(c,nil,">","BYD:LV",aux.FBF(Card.IsSetCard,0x2eb))
...
function cm.tfil1(c,e,tp)
	return c:IsSetCard(0x2eb) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsLevel(32)
end
