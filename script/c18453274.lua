...
function cm.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddXyzProcedure(c,aux.FBF(Card.IsSetCard,0x2eb),8,2)
...
function cm.tfun2(g,e,tp)
	return g:GetSum(Card.GetLevel)<=16 and g:IsExists(Card.IsCanBeSpecialSummoned,2,nil,e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
