...
function cm.ofil51(c,e,tp)
	return c:IsSetCard(0x2ef) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
		and not Duel.IEMCard(cm.ofil52,tp,"M",0,1,nil,c:GetCode())
end
function cm.ofil52(c,code)
