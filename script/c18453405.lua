...
s.listed_series={0x2da,0x12da}
function s.ssacechk(e)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsSetCard,0x12da),e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end
