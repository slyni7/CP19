...
function s.setfilter(c)
	return c:IsSetCard(0x2f1) and c:IsType(TYPE_SPELL) and c:IsSSetable()
end
...
function s.thfilter1(c)
	return c:IsFaceup() and c:IsSetCard(0x2f1) and c:IsAbleToGrave()
end
function s.thfilter2(c)
	return c:IsFaceup() and c:IsSetCard(0x2f1) and c:IsAbleToGrave() and c:GetSequence()<5
end
