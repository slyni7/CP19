...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x2f1) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_ATTACK)
end
...
function s.thfilter(c)
	return c:IsType(TYPE_SPELL) and c:IsSetCard(0x2f1) and c:IsAbleToHand()
end
