...
function s.tgfilter(c)
	return c:IsSetCard(0x2f1) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
...
function s.cfilter(c)
	return c:IsSetCard(0x2f1) and c:IsType(TYPE_MONSTER) and c:IsAbleToGraveAsCost()
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	if not re or not re:GetHandler():IsSetCard(0x2f1) then return end
