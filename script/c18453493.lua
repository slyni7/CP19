...
function s.cfilter(c,tp)
	return c:IsSetCard(0x12f2) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsControler(tp)
end
	--If it ever happened
...
function s.tgfilter(c)
	return c:IsSetCard(0x12f2) and c:IsAbleToGrave() and not c:IsCode(id)
end
	--Activation legality
