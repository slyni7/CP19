...
function s.setfilter(c)
	return c:IsType(TYPE_TRAP+TYPE_SPELL) and c:IsSetCard(0x12f2) and c:IsSSetable()
end
...
function s.thfilter(c,ft)
	return c:IsFaceup() and (ft>0 or c:GetSequence()<5) and c:IsSetCard(0x12f2) and not c:IsCode(id) and c:IsAbleToHand()
end
