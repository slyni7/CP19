...
s.listed_series={0xa2f2,0x22f2}
s.listed_names={18453509}
function s.thfilter1(c)
	return c:IsSetCard(0xa2f2) and c:IsAbleToHand()
end
...
function s.thfilter2(c,tp)
	return c:IsCode(18453509) and c:IsAbleToHand()
		and Duel.IsExistingMatchingCard(s.thfilter3,tp,LOCATION_DECK,0,1,c)
end
function s.thfilter3(c)
	return c:IsSetCard(0x22f2) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end
