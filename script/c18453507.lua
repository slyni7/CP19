...
function s.spfilter(c,tp)
	return c:IsSetCard(0x12f2) and c:IsControler(tp) and c:IsFaceup() and not c:IsCode(id)
end
...
function s.cfilter(c,tp)
	return c:IsSetCard(0x12f2) and (c:IsLocation(LOCATION_HAND) or c:IsFaceup()) and c:IsAbleToGraveAsCost()
end
