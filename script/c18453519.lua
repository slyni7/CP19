...
function s.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x12f2) and c:IsLinkMonster()
end
...
function s.lkfilter(c,tp)
	return c:IsSetCard(0x12f2) and c:IsLinkMonster() and c:IsReincarnationSummoned() and c:GetControler()==tp
end
	--If it ever happened
