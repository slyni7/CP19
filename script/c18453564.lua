...
function s.initial_effect(c)
	...
	e14:SetCode(EFFECT_CANNOT_DISABLE_SUMMON)
	...
	e16:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_CANNOT_NEGATE+EFFECT_FLAG_CANNOT_INACTIVATE)
	WriteEff(e16,16,"TO")
...
function s.tfil16(c)
	return c:IsSetCard("저지불가") and c:IsType(TYPE_TRAP) and c:IsSSetable()
end
