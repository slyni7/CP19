...
function s.spfilter(c,e,tp)
	return (c:IsSetCard(0x12c4) or c:IsCode(46659709)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.thfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x12c4) and c:IsType(TYPE_TRAP) and c:IsAbleToHand()
end
