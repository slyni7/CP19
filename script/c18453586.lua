...
function s.cfilter(c)
	return c:IsFaceup() and (c:IsCode(46659709) or (c:IsSetCard(0x12c4) and c:IsMonster()))
end
function s.tgfilter(c)
	return c:IsMonster() and c:IsSetCard(0x12c4) and c:IsAbleToGrave()
end
...
function s.thfilter(c)
	return c:IsSetCard(0x12c4) and c:IsType(TYPE_TRAP) and c:IsAbleToHand()
end
