...
function s.poscon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(aux.FilterFaceupFunction(Card.IsCode,46659709),tp,LOCATION_ONFIELD,0,1,nil)
...
function s.thfilter(c)
	return c:IsSetCard(0x12c4) and c:IsMonster() and c:IsAbleToHand()
end
