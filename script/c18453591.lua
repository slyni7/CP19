...
function s.cfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x2d7)
end
...
s.square_mana={ATTRIBUTE_EARTH,ATTRIBUTE_EARTH,ATTRIBUTE_EARTH,ATTRIBUTE_EARTH,ATTRIBUTE_EARTH,ATTRIBUTE_EARTH,ATTRIBUTE_EARTH}
