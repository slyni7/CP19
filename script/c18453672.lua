...
s.square_mana={ATTRIBUTE_FIRE,ATTRIBUTE_FIRE,ATTRIBUTE_FIRE}
s.custom_type=CUSTOMTYPE_SQUARE
function s.cfil1(c)
	return not c:IsPublic() and c:GetLevel()>0
end
...
function s.tfil22(c)
	return c:IsSetCard("付规") and c:IsFaceup()
end
function s.tar2(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then
		return Duel.IEMCard(s.tfil21,tp,"D",0,1,nil,e,tp,c)
	end
