...
function s.initial_effect(c)
	...
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_CANNOT_INACTIVATE+EFFECT_FLAG_CANNOT_NEGATE)
...
function s.tar1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		return Duel.IETarget(s.tfil1,tp,"O",0,1,nil)
			and Duel.IETarget(Card.IsAbleToHand,tp,0,"O",1,nil)
	end
...
function s.tfil3(c)
	return c:IsAbleToHand() and c:IsCode(18453898)
end
...
function s.tfil6(c)
	return c:IsAbleToHand() and c:IsCode(18453891)
end
