...
function s.tfil1(c,e,tp)
	return c:IsSetCard("vingt et un") and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(id)
end
...
function s.tfil3(c)
	return c:IsAbleToHand() and c:IsCode(18453896)
end
...
function s.tfil6(c)
	return c:IsAbleToHand() and c:IsCode(18453892)
end
