...
function s.tar1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		return #g>0 and Duel.GetLocCount(tp,"M")>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
	end
...
function s.tfil3(c)
	return c:IsAbleToHand() and c:IsCode(18453899)
end
...
function s.tfil6(c)
	return c:IsAbleToHand() and c:IsCode(18453885)
end
