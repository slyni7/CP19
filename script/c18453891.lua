...
function s.tfil1(c)
	return c:IsSetCard("vingt et un") and c:IsAbleToHand() and c:IsType(TYPE_TRAP)
end
...
function s.tfil3(c)
	return c:IsAbleToHand() and c:IsCode(18453895)
end
...
function s.tfil6(c)
	return c:IsAbleToHand() and c:IsCode(18453888)
end
