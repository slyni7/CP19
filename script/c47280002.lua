...
function cm.eqfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xe25) and not c:IsAttribute(ATTRIBUTE_FIRE)
end
...
function cm.effilter(c,e,tp)
	return c:IsSetCard(0xe25) and c:IsAbleToGrave() and not c:IsAttribute(ATTRIBUTE_FIRE)
end
