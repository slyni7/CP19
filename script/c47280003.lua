...
function cm.eqfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xe25) and not c:IsAttribute(ATTRIBUTE_WIND)
end
...
function cm.effilter(c,e,tp)
	return c:IsSetCard(0xe25) and c:IsAbleToHand() and not c:IsAttribute(ATTRIBUTE_WIND)
end
