...
function cm.spfilter(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x5f5) and c:IsType(TYPE_MONSTER) and c:IsSummonableCard() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.synop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetDescription(aux.Stringid(52645001,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
...
function cm.xyzop(e,tp,eg,ep,ev,re,r,rp)
	...
	local rc=c:GetReasonCard()
	local e1=Effect.CreateEffect(rc)
	e1:SetDescription(aux.Stringid(52645001,1))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetRange(LOCATION_MZONE)
...
function cm.linkop(e,tp,eg,ep,ev,re,r,rp)
	...
	local rc=c:GetReasonCard()
	local e1=Effect.CreateEffect(rc)
	e1:SetDescription(aux.Stringid(52645001,2))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetRange(LOCATION_MZONE)
...
function cm.nfusop(e,tp,eg,ep,ev,re,r,rp)
	...
	local rc=c:GetReasonCard()
	local e1=Effect.CreateEffect(rc)
	e1:SetDescription(aux.Stringid(52645001,3))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetRange(LOCATION_MZONE)
