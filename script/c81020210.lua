...
function cm.tg1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 
		...
		and Duel.IsPlayerCanSpecialSummonMonster(tp,m,0xca2,0x21,4,2000,100,RACE_PLANT,ATTRIBUTE_WIND)
	end
...
function cm.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.IsPlayerCanSpecialSummonMonster(tp,m,0xca2,0x21,4,2000,100,RACE_PLANT,ATTRIBUTE_WIND) then
...
function cm.tfilter0(c,tp)
	...
	and c:GetType()~=0x2
	and not c:IsHasEffect(81020210)
end
