...
function cm.initial_effect(c)
	...
	e4:SetCode(EVENT_SUMMON_NEGATED)
...
function cm.tfil0(c)
	return c:IsSSetable() and c:IsSetCard(0xc93) and c:IsType(0x2)
end
...
--서치
function cm.tfil1(c)
	return c:IsAbleToHand() and c:IsSetCard(0xc92) and c:IsAttribute(0x20)
end
