...
function cm.mfil0(c,e,tp)
	...
	and Duel.IsExistingMatchingCard(cm.mfil1,tp,0x01+0x02,0,1,c,e,tp,c,c:GetLevel())
end
...
function cm.tg3(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		and Duel.IsExistingMatchingCard(cm.mfil0,tp,0x01+0x02,0,2,nil,e,tp)
	end
...
function cm.op3(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.SelectMatchingCard(tp,cm.mfil0,tp,0x01+0x02,0,1,1,nil,e,tp)
	local tc=g1:GetFirst()
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g2=Duel.SelectMatchingCard(tp,cm.mfil1,tp,0x01+0x02,0,1,1,tc,e,tp,tc,tc:GetLevel())
	g1:Merge(g2)
	if g1 and #g1==2 then
