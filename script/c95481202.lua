--파라바이오트 테러
function c95481202.initial_effect(c)
	--special summon
	...
	e1:SetCondition(c95481202.tdcon)
	e1:SetTarget(c95481202.tdtg)
	e1:SetOperation(c95481202.tdop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e4:SetCondition(c95481202.spcon)
	e4:SetTarget(c95481202.sptg)
	e4:SetOperation(c95481202.spop)
	c:RegisterEffect(e4)
	--to hand
	...
	e5:SetCountLimit(1,95481202)
	e5:SetTarget(c95481202.thtg)
	e5:SetOperation(c95481202.thop)
	c:RegisterEffect(e5)
end
...
function c95481202.tdop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c95481202.rmfilter(c)
	return c:IsAbleToRemove()
end
function c95481202.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return true end
	local g=Duel.GetMatchingGroup(c95481202.rmfilter,tp,LOCATION_HAND,0,c)
...
function c95481202.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFieldGroupCount(tp,0,LOCATION_DECK)>0 end
end
function c95481202.cfilter(c)
	return c:IsSetCard(0xd47) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(95481202)
end
function c95481202.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,1-tp,aux.Stringid(95481202,0))
	local tg=Duel.GetMatchingGroup(c95481202.cfilter,tp,0,LOCATION_DECK,nil)
