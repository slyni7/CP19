...
function cm.myuop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(99000200,RESET_EVENT+RESETS_STANDARD,0,0)
end
function cm.myulimit(e,c,sump,sumtype,sumpos,targetp,se)
	return c:GetFlagEffect(99000200)>0
end
...
function cm.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:GetFlagEffect(99000200)==0 end
...
function cm.recop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsType(TYPE_MONSTER) and tc:IsSetCard(0x1c20) and tc:IsLocation(LOCATION_GRAVE) then
