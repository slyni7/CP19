...
function cm.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chkc then return chkc:IsOnField() and chkc:IsControler(tp) and cm.desfilter(chkc,ft) end
	if chk==0 then return ft>-1 and Duel.IsExistingTarget(cm.desfilter,tp,LOCATION_ONFIELD,0,1,nil,ft)
...
function cm.matfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x5d6d) and c:IsType(TYPE_XYZ)
end
